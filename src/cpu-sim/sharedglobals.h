...
//UNT add
bool coRun = false;
int gsfFrameCount[36] = {0};
int gsfWindowSize = 4;
int gsfFlit[36] = {10};
long long unsigned CoreFlitCount[36][36] = {0};
long long unsigned gsfFlitCou = 0;
long long unsigned LatencyCount[36][36];
long long unsigned LatencyCycle[36][36];
long long unsigned gpusimcycle = 0;
long long unsigned gputotsimcycle = 0;
long long unsigned CPUFlitCount[1000] = {0};
long long unsigned GPUFlitCount[1000] = {0};
